...
public class MercuryIllustration<r> extends Application {
    ...
    private Node prepareEarth() {
        ...
        earthMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/mercurymap.jpg")));
        earthMaterial.setSpecularMap(new Image(getClass().getResourceAsStream("/imageResource/mercurybump.jpg")));
