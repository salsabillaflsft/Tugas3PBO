...
public class SaturnIllustration<r> extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        world.getChildren().add(prepareSaturn());
    ...
    private Node prepareSaturn() {
        ...
        saturnMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/saturnmap.jpg")));
        //marsMaterial.setSpecularMap(new Image(getClass().getResourceAsStream("/imageResource/marsbump1k.jpg")));
        //saturnMaterial.setBumpMap(new Image(getClass().getResourceAsStream("/imageResource/mars_1k_normal.jpg")));

        sphere.setRotationAxis(Rotate.Y_AXIS);
        sphere.setMaterial(saturnMaterial);
        return sphere;
    }
