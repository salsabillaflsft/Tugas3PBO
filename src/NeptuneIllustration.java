...
public class NeptuneIllustration<r> extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        world.getChildren().add(prepareNeptune());
    ...
    private Node prepareNeptune() {
        ...
        neptuneMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/neptunemap.jpg")));
        ...
        sphere.setMaterial(neptuneMaterial);
        return sphere;
    }
