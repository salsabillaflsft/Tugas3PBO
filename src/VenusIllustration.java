...
public class VenusIllustration<r> extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        world.getChildren().add(prepareVenus());
    ...
    private Node prepareVenus() {
        ...
        venusMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/venusmap.jpg")));
        //venusMaterial.setSpecularMap(new Image(getClass().getResourceAsStream("/imageResource/venusbump.jpg")));
        venusMaterial.setBumpMap(new Image(getClass().getResourceAsStream("/imageResource/venusbump.jpg")));

        sphere.setRotationAxis(Rotate.Y_AXIS);
        sphere.setMaterial(venusMaterial);
        return sphere;
    }
