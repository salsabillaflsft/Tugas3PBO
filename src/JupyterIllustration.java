...
public class JupyterIllustration<r> extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        world.getChildren().add(prepareJupyter());
    ...
    private Node prepareJupyter() {
        PhongMaterial jupyterMaterial = new PhongMaterial();
        jupyterMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/jupitermap.jpg")));
        jupyterMaterial.setSpecularMap(new Image(getClass().getResourceAsStream("/imageResource/mercurybump.jpg")));
        //earthMaterial.setBumpMap(new Image(getClass().getResourceAsStream("/imageResource/mercurybump.jpg")));

        sphere.setRotationAxis(Rotate.Y_AXIS);
        sphere.setMaterial(jupyterMaterial);
        return sphere;
    }
