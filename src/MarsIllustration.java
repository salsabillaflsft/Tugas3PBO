...
public class MarsIllustration<r> extends Application {
    ...
    private Node prepareMars() {
        ...
        marsMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/imageResource/mars_1k_color.jpg")));
        //marsMaterial.setSpecularMap(new Image(getClass().getResourceAsStream("/imageResource/marsbump1k.jpg")));
        marsMaterial.setBumpMap(new Image(getClass().getResourceAsStream("/imageResource/mars_1k_normal.jpg")));
